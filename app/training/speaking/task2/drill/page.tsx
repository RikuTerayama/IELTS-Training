  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="text-2xl font-bold mb-6">Speaking Task 2 - 瞬間英作文</h1>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
              ...
              {currentPrompt.cue_card && (
                <div className="mb-4 p-4 bg-gray-50 rounded">
                  <h3 className="font-semibold mb-2">{currentPrompt.cue_card.topic}</h3>
                  <ul className="list-disc list-inside space-y-1">
                    {currentPrompt.cue_card.points?.map((point: string, i: number) => (
                      <li key={i}>{point}</li>
                    ))}
                  </ul>
                </div>
